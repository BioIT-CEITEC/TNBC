...
### 5. External Validation (`Validation_articles_backtransformed.R`)

**Goal**: Apply the trained model to external proteomic data.

**Methods**:
- Back-transform log₂ TMT ratios using sample medians.
- Impute missing values from the 5th percentile of low-intensity values.
- Calculate fold changes and predict TNBC subtypes.
